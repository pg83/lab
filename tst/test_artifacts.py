...
class HTTPTests(unittest.TestCase):
    ...
    def test_upload_hash_idempotency_and_view(self):
        ...
        status304, headers304, body304 = self.request('GET', path + '/', headers={'If-None-Match': headers['ETag']})
        self.assertEqual((status304, body304), (304, b''))
        self.assertNotIn('Content-Length', headers304)
        self.assertNotIn('Content-Type', headers304)
